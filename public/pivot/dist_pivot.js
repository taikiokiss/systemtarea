  ...
  callWithJQuery(function($) {
    ...
    locales = {
      en: {
        ...
        renderers: renderers,
        localeStrings: {
          renderError: "Se produjo un error al renderizar los resultados de la tabla dinámica.",
          computeError: "Se produjo un error al calcular los resultados de la tabla dinámica.",
          uiRenderError: "Se produjo un error al renderizar la interfaz de usuario de la tabla dinámica.",
