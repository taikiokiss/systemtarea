                ...
                <!-- inicio -->
                        <div class="form-group row">
                            ...
                            <label for="departamento" class="col-form-label text-md-left">{{ __('Departamento') }}</label>
                                <select readonly id="departamento" class="form-control" name="departamento">
                            ...
                            <label for="asign_a" class="col-form-label text-md-left">{{ __('Asignar a') }}</label>
                                <select readonly id="asign_a" class="form-control" name="asign_a" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <label for="asunto" class="col-form-label text-md-left">{{ __('Asunto') }}</label>
                                <input readonly id="asunto" type="text" class="form-control @error('asunto') is-invalid @enderror" name="asunto" onkeyup="this.value = this.value.toUpperCase();" value="{{ $tasks1[0]->asunto }}"  autocomplete="asunto" autofocus >
                            </div>


                            <div class="col-md-2">
                            <label for="fecha_entrega" class="col-form-label text-md-left">{{ __('Fecha de entrega') }}</label>
                                <input readonly id="fecha_entrega" type="date" class="form-control" value="<?php echo date('Y-m-d',strtotime($tasks1[0]->fecha_entrega));?>" name="fecha_entrega" >
                            </div>


                            <div class="col-md-2">
                            <label for="rcada" class="col-form-label text-md-left">{{ __('Repetir cada') }}</label>
                                <select  readonly class="custom-select target form-control @error('rcada') is-invalid @enderror" id="rcada" name="rcada">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="descripcion" class="col-form-label text-md-left">{{ __('Detalle') }}</label>
                                <textarea readonly id="descripcion" class="form-control" name="descripcion" onkeyup="this.value = this.value.toUpperCase();" rows="5">{{ $tasks1[0]->descripcion }}</textarea>
                            </div>
                        </div>
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade" id="nav-adjuntos" role="tabpanel" aria-labelledby="nav-adjuntos-tab">
            ...
            <div class="form-group row">
                ...
                <table class="table table-bordered table-striped table-sm table-responsive" style="font-size:12px">
                    <thead>
                        <tr>
                            <th width="80px" style="text-align: center"># Tarea</th>
                            <th width="800px" style="text-align: center">Nombre de Archivo</th>
