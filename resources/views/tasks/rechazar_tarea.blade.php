...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h4 style="display:inline;">Rechazar Tarea</h4>
...
{!! Form::model($tasks, ['route' => ['tasks.actualizar_estados_tareas', $tasks->id, 'RECHAZAR'],'method' => 'PUT','enctype' =>'multipart/form-data', 'files'=>true]) !!}
...
<div class="container-fluid" style="font-size: 12px;">
    ...
    <div class="form-group row was-validated mt-3">
        <div class="col-md-12 col-md-offset-4 text-md-left">
            <button type="submit" class="btn btn-primary btn-block" value="Rechazar">
                Rechazar
            </button>
        </div>
    </div>
