    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-webpanel-c sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                ...
                <div class="sidebar-brand-text mx-3">WEB PANEL RS</div>
            </a>
            ...
            <li class="nav-item">
              ...
              <div id="collapseFooda" class="collapse" aria-labelledby="headingUtilities"
                  ...
                  <div class="bg-white py-2 collapse-inner rounded">
                      <a class="collapse-item" href="#">Admi. Usuarios</a> 
                      <a class="collapse-item" href="#">Admi. Roles</a>
                      <a class="collapse-item" href="#">Admi. Parametros</a>
                  </div>
              </div>
          </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFooda5"
                    aria-expanded="true" aria-controls="collapseFooda5">
                    <i class="fab fa-product-hunt"></i>
                    <span>Ejemplo</span>
                </a>
                <div id="collapseFooda5" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Disponibles</a> 
                        ...
                        <!-- Nav Item - User Information -->
                          <li class="nav-item dropdown">
                              <a style="font-size: 14px;" id="navigation" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="color: black;">
                                {{ dd(Auth::user()->person[0]->last_name) }} {{ Auth::user()->person[0]->name }}
                              </a>
